...
`;function pt(e,t){return n=>n?e():t()}function ht(e){return pt(e,(()=>null))}function yt(e){return ht((()=>({opacity:0})))(e)}const gt=e=>{const{cascade:t=!1,damping:n=.5,delay:a=0,duration:o=1e3,fraction:i=0,keyframes:s=it,triggerOnce:l=!1,className:c,style:u,childClassName:f,childStyle:d,children:m,onVisibilityChange:p}=e,h=(0,r.useMemo)((()=>function({duration:e=1e3,delay:t=0,timingFunction:n="ease",keyframes:r=it,iterationCount:a=1}){return Re`
  ...
  `}({keyframes:s,duration:o})),[o,s]);return null==m?null:"string"==typeof(y=m)||"number"==typeof y||"boolean"==typeof y?ze(bt,{...e,animationStyles:h,children:String(m)}):(0,et.isFragment)(m)?ze(wt,{...e,animationStyles:h}):ze(Ie,{children:r.Children.map(m,((s,m)=>{if(!(0,r.isValidElement)(s))return null;const y=a+(t?m*o*n:0);switch(s.type){case"ol":case"ul":return ze(De,{children:({cx:t})=>ze(s.type,{...s.props,className:t(c,s.props.className),style:Object.assign({},u,s.props.style),children:ze(gt,{...e,children:s.props.children})})});case"li":return ze(Ze,{threshold:i,triggerOnce:l,onChange:p,children:({inView:e,ref:t})=>ze(De,{children:({cx:n})=>ze(s.type,{...s.props,ref:t,className:n(f,s.props.className),css:ht((()=>h))(e),style:Object.assign({},d,s.props.style,yt(!e),{animationDelay:y+"ms"})})})});default:return ze(Ze,{threshold:i,triggerOnce:l,onChange:p,children:({inView:e,ref:t})=>ze("div",{ref:t,className:c,css:ht((()=>h))(e),style:Object.assign({},u,yt(!e),{animationDelay:y+"ms"}),children:ze(De,{children:({cx:e})=>ze(s.type,{...s.props,className:e(f,s.props.className),style:Object.assign({},d,s.props.style)})})})})}}))});var y},vt={display:"inline-block",whiteSpace:"pre"},bt=e=>{const{animationStyles:t,cascade:n=!1,damping:r=.5,delay:a=0,duration:o=1e3,fraction:i=0,triggerOnce:s=!1,className:l,style:c,children:u,onVisibilityChange:f}=e,{ref:d,inView:m}=Ke({triggerOnce:s,threshold:i,onChange:f});return pt((()=>ze("div",{ref:d,className:l,style:Object.assign({},c,vt),children:u.split("").map(((e,n)=>ze("span",{css:ht((()=>t))(m),style:{animationDelay:a+n*o*r+"ms"},children:e},n)))})),(()=>ze(wt,{...e,children:u})))(n)},wt=e=>{const{animationStyles:t,fraction:n=0,triggerOnce:r=!1,className:a,style:o,children:i,onVisibilityChange:s}=e,{ref:l,inView:c}=Ke({triggerOnce:r,threshold:n,onChange:s});return ze("div",{ref:l,className:a,css:ht((()=>t))(c),style:Object.assign({},o,yt(!c)),children:i})};Be`
  from,
  20%,
  40%,
  60%,
...
`;const $t=e=>{const{big:t=!1,direction:n,reverse:a=!1,...o}=e,i=(0,r.useMemo)((()=>function(e,t,n){switch(n){case"bottom-left":return t?xt:nt;case"bottom-right":return t?Ct:rt;case"down":return e?t?kt:ot:t?St:at;case"left":return e?t?Ot:st:t?Nt:it;case"right":return e?t?Pt:ct:t?_t:lt;case"top-left":return t?Tt:ut;case"top-right":return t?jt:ft;case"up":return e?t?Lt:mt:t?Mt:dt;default:return t?Et:tt}}(t,a,n)),[t,n,a]);return ze(gt,{keyframes:i,...o})};Be`
  from {

...
const Twitter = () => {
  return (
    <a href="https://twitter.com/mzking622" target="_blank">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="64"
        height="64"
...
const Instagram = () => {
  return (
    <a href="https://instagram.com/msageha" target="_blank">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="64"
        height="64"
...
const Linkedin = () => {
  return (
    <a href="https://www.linkedin.com/in/mizuki-sango" target="_blank">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="64"
        height="64"
  ...
  return (
    <section id="sns" className="bg-gray-900 text-white">
      ...
      <Fade duration={1000} delay={600} className=" md:flex md:justify-center">
        <div className="flex items-center justify-evenly md:w-1/2">
          <Github />
          <Twitter />
          <Instagram />
          <Linkedin />
